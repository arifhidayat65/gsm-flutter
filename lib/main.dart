...
import 'package:apps_pajak/features/cek_pajak/pages/cek_pajak_page.dart';
...
void main() {
  CekPajakApi.setLogging(enabled: true);
  runApp(const MyApp());
}
    ...
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          useMaterial3: true,
          colorScheme: (() {
            // Tokopedia green as primary
            final base = ColorScheme.fromSeed(seedColor: const Color(0xFF03AC0E));
            return base.copyWith(
              secondary: const Color(0xFF35C53C),
            );
          })(),
